    ...
    <main>
        ...
        <div id="content_main">
            <?php
                ...
                (`cpf`, `nome`, `email`, `telefone`, `cep`, `bairro`, `cidade`, `rua`, `numero`) VALUES 
                ('$cpf','$nome','$email','$telefone','$cep','$bairro','$cidade','$rua','$numero')";

                if(mysqli_query($conn, $sql)){
                    print('<div class="alerta sucesso">Cliente cadastrado com sucesso</div>');
                } else {
