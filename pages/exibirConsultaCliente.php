...
<head>
    ...
    <link rel="stylesheet" href="../styles/botaoSimOuNao.css">
    ...
    <main>
        ...
        <div id="content_main">
            <?php
                ...
                $pesquisaCpf = $_POST["busca"];

                if($pesquisaCpf != null) {
                    $sql = "SELECT * FROM clientes WHERE cpf='$pesquisaCpf'";
                    ...
                    while($linha = mysqli_fetch_assoc($dados)){
                        ...
                        echo
                                    ...
                                    <a class='botaoSim' href='editarCliente.php?id=$cpf'>Editar</a>
                                    <a class='botaoNao' href='apagarCliente.php?id=$cpf'>Excluir</a>
                                    
                                ";
                        }

                    if ($var == 0){
                        print('<div class="alerta atencao">Não existe cliente cadastrado com este CPF</div>');
                    }     
                } 
